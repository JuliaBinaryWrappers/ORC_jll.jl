# Autogenerated wrapper script for ORC_jll for x86_64-apple-darwin14
...
const liborc_splitpath = ["lib", "liborc-0.4.0.dylib"]
...
const liborc = "@rpath/liborc-0.4.0.dylib"


# Relative path to `liborc_test`
const liborc_test_splitpath = ["lib", "liborc-test-0.4.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const liborc_test = "@rpath/liborc-test-0.4.0.dylib"
