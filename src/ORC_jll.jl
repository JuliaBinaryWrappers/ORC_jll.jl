...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import ORC_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("fb41591b-4dee-5dae-bf56-d83afd04fbc0"))
platforms = [Pkg.Artifacts.unpack_platform(e, "ORC", artifacts_toml) for e in artifacts["ORC"]]
...
if best_platform === nothing
    @debug("Unable to load ORC; unsupported platform $(triplet(platform_key_abi()))")
else
